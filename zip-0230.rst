...
The encodings of ``tx_in``, and ``tx_out`` are as in a version 4 transaction.
The encodings of ``SpendDescriptionV6``, ``OutputDescriptionV6``
...
| Bytes | Name          | Data Type                   | Description                                                                                                               |
+=======+===============+=============================+===========================================================================================================================+
| 32    | ``AssetBase`` | ``byte[32]``                | For the Orchard-ZSA protocol, this is the byte encoding of the Asset Base :math:`\mathsf{asset\_base}` defined in         |
|       |               |                             | ZIP 226: Note Structure & Commitment [#zip-0226-note-structure-commitment]_.                                              |
+-------+---------------+-----------------------------+---------------------------------------------------------------------------------------------------------------------------+
...
| Bytes                       | Name                     | Data Type                                 | Description                                                         |
+=============================+==========================+===========================================+=====================================================================+
|``2``                        |``assetDescSize``         |``compactSize``                            |The length of the asset description string in bytes.                 |  
+-----------------------------+--------------------------+-------------------------------------------+---------------------------------------------------------------------+
...
.. [#zip-0226-note-structure-commitment] `ZIP 226: Transfer and Burn of Zcash Shielded Assets - Note Structure & Commitment <https://qed-it.github.io/zips/zip-0226#note-structure-commitment>`_
