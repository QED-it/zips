...
Note that :math:`nOrchardActions` is redefined in the above table, and now combines the actions for native ZEC as well as OrchardZSA transfer actions for Custom Assets. 

The formula for the computation of the :math:`zsa\_logical\_actions` is:
