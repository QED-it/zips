...
A party trying to tweak the expiry height or other details of received orders while matching orders will then need to be able to successfully forge the sender's Spend Authorization Signature.
...
Hence, $\mathsf{bsk}$ “binds together" the Action Groups in the Order, preventing selective extraction of specific Actions in a Swap Order by a malicious matcher.
