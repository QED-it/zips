...
The Asset Base is the unique identifier of the Asset in the Orchard-ZSA Protocol.
Wallets MUST NOT display just the :math:`\mathsf{asset\_desc}` string to their users as the name of the Asset.
