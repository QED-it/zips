...
The ZSA Orchard Action size differs from the Orchard Action size by 32 bytes. This implies that the size goes from 820 bytes in the Orchard Action to 852 bytes in the ZSA Orchard Action.
